export class StudentManager {
    ...
    findStudentsByName(name) {
        const search_term = name.toLowerCase();
        return this.students.filter(s => s.first_name.toLowerCase().includes(search_term) ||
            s.last_name.toLowerCase().includes(search_term));
    }
